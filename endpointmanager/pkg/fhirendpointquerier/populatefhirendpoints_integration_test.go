...
func Test_Integration_AddEndpointData(t *testing.T) {
	...
	var listOfEndpoints, listErr = fetcher.GetEndpointsFromFilepath("../../resources/EpicEndpointSourcesDSTU2.json", "FHIR", "https://open.epic.com/Endpoints/DSTU2")
	...
	listOfEndpoints, listErr = fetcher.GetEndpointsFromFilepath("../../resources/EpicEndpointSourcesDSTU2_1.json", "FHIR", "https://open.epic.com/Endpoints/DSTU2")
	th.Assert(t, listErr == nil, "Endpoint List Parsing Error")
	err = AddEndpointData(ctx, store, &listOfEndpoints)
	th.Assert(t, err == nil, err)
	rows = store.DB.QueryRow("SELECT COUNT(*) FROM fhir_endpoints;")
